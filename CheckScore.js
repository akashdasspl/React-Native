...
export default class  CheckScore extends React.Component {
  render () {
    return (
     <View
        style={{
      ...
      ><View
        ...
        <Tab.Navigator
            ...
            screenOptions={{
              ...
              tabBarIndicatorStyle:{backgroundColor:'#2D3481'
              }
          ...
          >
             <Tab.Screen
              name="Check for AM"
              component={class  Check extends React.Component {
  render () {
    return (<View
    ...
    flex:1}}>
        ...
        <TouchableOpacity>
          <View style={styles.ViewStl}>
            ...
            <Tab.Screen
              name="Check for SE"
              component={class Check2 extends React.Component {
  render () {
    return (
      <View
        style={{
