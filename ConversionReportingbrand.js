...
export default class ConversionReportingbrand extends React.Component {
  render () {
    return (
      <View
        style={{
      ...
      >
        ...
        >
          ...
          <Image source={require ('../asset/images/Frame10.png')} />
          <Text
            style={{
        ...
        <ScrollView>
          ...
          >
            ...
            >
              <Image
                style={styles.Image}
                source={require ('../asset/images/Frame10.png')}
              />
          ...
          <View style={styles.ViewStl}>
            ...
            >
              <Image
                ...
                source={require ('../asset/images/Frame10.png')}
              />
              <Text style={styles.text}>Test Brand</Text>
            </View>
            <View style={styles.rowView}>
              <TouchableOpacity style={styles.orangeView}>
                <Text style={styles.orange}>
